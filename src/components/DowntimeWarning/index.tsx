  ...
  switch (chainId) {
    ...
    case SupportedChainId.OPTIMISTIC_KOVAN:
      return (
        <Wrapper>
          <Trans>
            Optimism is in Beta and may experience downtime. Optimism expects
            planned downtime to upgrade the network in the near future. During
            downtime, your position will not earn fees and you will be unable to
            remove liquidity.{" "}
      ...
      return (
        <Wrapper>
          <Trans>
            ...
            your position will not earn fees and you will be unable to remove
            liquidity.{" "}
