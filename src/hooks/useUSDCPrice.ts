...
import { DAI_OPTIMISM, DOGE_PULSE, USDC_ARBITRUM, USDC_MAINNET, USDC_POLYGON } from '../constants/tokens'
...
export const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [SupportedChainId.PULSECHAIN]: CurrencyAmount.fromRawAmount(DOGE_PULSE, 10_000e6),
}
